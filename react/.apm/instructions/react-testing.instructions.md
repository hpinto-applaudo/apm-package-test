...
This is a shared package; it does not know the host repo's exact tooling or thresholds. Detect the repo's configuration and enforce whatever gates exist.
